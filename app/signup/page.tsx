    ...
    <main className="min-h-screen flex items-center justify-center bg-slate-50">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-8">
          <h1 className="text-xl font-semibold text-slate-900 text-center mb-6">Create your account</h1>
          ...
          <div className="space-y-4">
            <div>
              <label className="text-sm text-slate-600 font-medium block mb-1.5">Full Name</label>
              <input
                type="text"
                value={fullName}
            ...
            <div>
              <label className="text-sm text-slate-600 font-medium block mb-1.5">Company Name</label>
              <input
                type="text"
                value={companyName}
          ...
          {inviteToken ? (
            <p className="text-xs text-emerald-600 text-center mt-4">You're joining an existing team. Your role and permissions have been set by your administrator.</p>
          ) : (
            <p className="text-xs text-slate-400 text-center mt-4">Starting a new account? You'll be set up as the account owner.</p>
          )}
